...
echo "[7/7] Configuring panel..."
sleep 2
docker exec 3xui_app /app/x-ui setting -webBasePath "/$ADMIN_PATH/" >/dev/null 2>&1
docker restart 3xui_app >/dev/null 2>&1
echo "  Panel base path set to /$ADMIN_PATH/"
